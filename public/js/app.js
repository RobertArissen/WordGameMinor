...
Component.options.__file = "resources/js/components/GameControl.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3af93a70", Component.options)
  } else {
    hotAPI.reload("data-v-3af93a70", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        gameStartedBus: function gameStartedBus() {
            var _this = this;

            EventBus.$on('gameStarted', function (gameStarted) {
                _this.gameStarted = gameStarted;

                _this.emitActiveWord();
            });
        },
        emitActiveWord: function emitActiveWord() {
            EventBus.$emit('activeWord', this.words[this.wordIndex].word);
        },
        hitLetter: function hitLetter() {
            var _this2 = this;

            EventBus.$on('hitLetter', function (letter) {
                if (letter.toLowerCase() === _this2.words[_this2.wordIndex].word[_this2.activeLetter].toLowerCase()) {
                    _this2.correctLetters++;
                    _this2.activeLetter++;
                    _this2.score += _this2.words[_this2.wordIndex].score / _this2.words[_this2.wordIndex].word.length;
                    EventBus.$emit('score', _this2.score);

                    if (_this2.correctLetters === _this2.words[_this2.wordIndex].word.length) {
                        if (_this2.words.length !== _this2.wordIndex + 1) {
                            _this2.wordIndex++;
                    ...
                    _this2.playerHealth--;
                    EventBus.$emit('playerHealth', _this2.playerHealth);
                }
            });
        }
    }
      ...
      _c(
        ...
        [
          _c("question", {
            attrs: {
              words: _vm.words,
              wordIndex: _vm.wordIndex,
              correctLetters: _vm.correctLetters,
              activeLetter: _vm.activeLetter
            }
          }),
          _vm._v(" "),
          _c("words", {
            attrs: {
              words: _vm.words,
              wordIndex: _vm.wordIndex,
              playedOut: _vm.playedOut
            }
          }),
          _vm._v(" "),
          _c("score", { attrs: { score: _vm.score } })
        ],
        1
      )
    ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3af93a70", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['words', 'wordIndex', 'correctLetters', 'activeLetter'],
    ...
    methods: {
        countLetters: function countLetters() {
            if (this.words.length > 0) this.letterCount = this.words[this.wordIndex].word.length;
        }
    },
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.words.length > 0
    ? _c("div", { staticClass: "bg-white shadow p-4 h-auto w-3/5 rounded" }, [
        _c("b", [
          _vm._v(
            "Het " +
              _vm._s(_vm.words[_vm.wordIndex].languageName) +
              " woord voor "
          ),
          _c("span", { staticClass: "text-blue" }, [
            _vm._v(_vm._s(_vm.words[_vm.wordIndex].wordDutch))
          ])
        ]),
        _vm._v(" "),
        _c(
          ...
          _vm._l(_vm.letterCount, function(n) {
            return _vm.correctLetters < n
              ? _c("div", {
                  staticClass: "bg-blue-dark h-1 w-5 mr-1 mt-5",
                  class: { "bg-blue-light": _vm.activeLetter + 1 === n }
                })
              : _c(
                  "div",
                  {
                    staticClass:
                      "w-5 mr-1 border-b-4 border-blue-darker text-bold text-center font-extrabold"
                  },
                  [
                    _vm._v(
                      _vm._s(_vm.words[_vm.wordIndex].word[n - 1].toUpperCase())
                    )
                  ]
                )
          })
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-513c1e37", Component.options)
  } else {
    hotAPI.reload("data-v-513c1e37", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "bg-white shadow p-4 rounded" }, [
    _c("b", { staticClass: "text-sm" }, [_vm._v("Score")]),
    _vm._v(" "),
    _c("h3", { staticClass: "text-blue mt-4" }, [_vm._v(_vm._s(_vm.score))])
  ])
}
var staticRenderFns = []
render._withStripped = true
